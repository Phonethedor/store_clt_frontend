    ...
    <div class="home-view" :style="heroStyle">
        <section class="home-view__hero hero">
            ...
            <div class="hero__content">
                ...
                <p class="hero__text">Descubre nuestra nueva línea de aromas botánicos diseñados para traer paz y equilibrio a tu hogar.
                </p>
        ...
        <section class="home-view__products products-section container">
            <div class="products-section__header header">
                ...
                <div class="header__controls controls">
                    <div class="controls__search local-search">
                        <svg class="local-search__icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
            ...
            <div v-else-if="sortedProducts.length > 0" 
                class="products-section__display" 
            ...
            <div v-else class="products-section__no-results no-results">
                <p class="no-results__text">No se encontraron productos que coincidan con "{{ searchStore.searchQuery }}"</p>
