...
<template>
    <div class="product-card staggered-fade"
        ...
        <div class="product-card__image-container">
            ...
            <div v-else-if="product.stock <= 5" class="product-card__badge product-card__badge--low">¡Últimas unidades!
            </div>

            <img :src="`http://localhost:3021/public/${product.imageUrl}`" :alt="product.name"
